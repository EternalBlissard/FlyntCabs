...
def view_profile(driver_id):
    ...
    print("Name: ", result[0][2])
    print("Phone number: ", result[0][3])
    print("Email: ", result[0][4])
    print("Password: ", result[0][5])
    print("License number: ", result[0][6])
    print("Address: ", result[0][7])
    print("Years of experience: ", result[0][8])
    print("Cab id: ", result[0][9])
    print("Rating: ", 0.0)
